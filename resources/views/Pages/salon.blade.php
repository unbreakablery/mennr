...
@section('content')
    ...
    <!-- Hero section -->
    <section class="section hero-section pink-bg">
    ...
    <section class="section">
      <div class="section-cutout cutout-top-right light-pink-bg"></div>
      <div class="site-wrapper">
        ...
        @foreach($salon as $value)
          ...
          @if($value->section_title == 'third_description')
            <div class="body-normal text-center">
              {{ $value->data }}
            </div>
          @endif
        @endforeach
