...
<div class="row">
  <div class="col-12 mb-4">
    <div class="card border-0 shadow components-section">
      <div class="card-body">
        {!! Form::open(['route' => ['plans.store'], 'enctype' => 'multipart/form-data']) !!}
        @if ($errors->any())
        ...
        <div class="row mb-4">
          <div class="col-lg-6 col-sm-6">
            <div class="mb-4">
              ...
              {{ form::select('type', [
                                ...
                                'yearly' => 'Yearly', 
                                'custom' => 'Custom', 
                              ], 'monthly', ['class' => 'form-control form-select', 'required' => true]) }}
            </div>
          </div>
          ...
          <div class="col-lg-6 col-sm-6">
            <div class="mb-4">
              ...
              {{ form::number('price', '0.00', ['class' => 'form-control', 'min' => '0.00', 'step' => '0.01']) }}
            </div>
          </div>
          <div class="col-lg-6 col-sm-6">
            <div class="mb-4">
          ...
          <div class="col-lg-6 col-sm-6">
            <div class="mb-4">
              ...
              {{ form::textarea('features', '', ['class' => 'form-control', 'id' => 'features', 'rows' => '4']) }}
            </div>
          </div>
