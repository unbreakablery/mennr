          ...
          <div class="row mb-4">
            ...
            <div class="col-lg-6 col-sm-6">
              ...
              <div class="mb-4">
                ...
                {{ form::text('tags', $post->tags, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'comma seperated items e.g Item 1, Item 2 etc']) }}
              </div>
            </div>
            <div class="col-lg-6 col-sm-6">
              <div class="mb-4">
                <label for="name">Post Description</label>
                {{ form::textarea('description', $post->description, ['class' => 'form-control', 'id' => 'description', 'rows' => '10']) }}
              </div>
            </div>
            <div class="col-lg-6 col-sm-6">
              <div class="mb-4">
