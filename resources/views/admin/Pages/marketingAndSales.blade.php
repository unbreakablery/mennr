...
<div class="py-4">
  <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
      ...
      <li class="breadcrumb-item"><a href="#">Marketing & Sales Page</a></li>
    </ol>
  </nav>
</div>
        ...
        <div class="row mb-4">
          <div class="col-lg-12 col-sm-6">
            <div class="mb-3">
              ...
              {!! Form::text('title', 'Marketing and Sales', ['class' => 'form-control', 'required' => 'required', 'readonly' => 'readonly']) !!}
            </div>
          </div>
          <!-- Section 1 -->
          ...
          <div class="col-lg-6 col-sm-6">
            <div class="mb-4">
              <label class="w-100">Section 9</label>
              <label class="w-100">Title<span class="text-danger">*</span></label>
              {!! Form::hidden('txt_name[]', 'section_9_title') !!}
              @if ($page->count() == 0)
                {!! Form::text('section_9_title', '', ['class' => 'form-control', 'required' => 'required']) !!}
              @else
                @foreach ($page as $value)
                  @if ($value->section_title == 'section_9_title')
                    {!! Form::text('section_9_title', $value->data, ['class' => 'form-control', 'required' => 'required']) !!}
                  @endif
                @endforeach
              @endif
            </div>
            <div class="mb-4">
              <label class="w-100">&nbsp;</label>
              <label class="w-100">Description</label>
              {!! Form::hidden('txt_name[]', 'section_9_description') !!}
              @if ($page->count() == 0)
                {!! Form::textarea('section_9_description', '', ['class' => 'form-control', 'id' => 'section_9_description', 'rows' => '4']) !!}
              @else
                @foreach ($page as $value)
                  @if ($value->section_title == 'section_9_description')
                    {!! Form::textarea('section_9_description', $value->data, ['class' => 'form-control', 'id' => 'section_9_description', 'rows' => '4']) !!}
                  @endif
                @endforeach
              @endif
            </div>
