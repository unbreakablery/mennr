                ...
                <div class="row mb-4">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="mb-4">
                            ...
                            {!! Form::hidden('txt_name[]', 'second_sub_title') !!}
                            @if(!$page->toArray())
                                {!! Form::text('second_sub_title', '', ['class'=> 'form-control']) !!}
                            @else
                                @foreach($page as $value)
                                    @if($value->section_title == 'second_sub_title')
                                        {!! Form::text('second_sub_title', $value->data, ['class'=> 'form-control']) !!}
                                    @endif
                                @endforeach
                            @endif
                        </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="mb-4">
                            <label>Sub Title</label>
                            {!! Form::hidden('txt_name[]', 'eighth_sub_title') !!}
                            @if(!$page->toArray())
                                {!! Form::text('eighth_sub_title', '', ['class'=> 'form-control']) !!}
                            @else
                                @foreach($page as $value)
                                    @if($value->section_title == 'eighth_sub_title')
                                        {!! Form::text('eighth_sub_title', $value->data, ['class'=> 'form-control']) !!}
                                    @endif
                                @endforeach
                            @endif
                        </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="mb-4">
                            <label>Ninth Section</label><br>
                            <label>Title</label>
                            {!! Form::hidden('txt_name[]', 'ninth_title') !!}
                            @if(!$page->toArray())
                                {!! Form::text('ninth_title', '', ['class'=> 'form-control']) !!}
                            @else
                                @foreach($page as $value)
                                    @if($value->section_title == 'ninth_title')
                                        {!! Form::text('ninth_title', $value->data, ['class'=> 'form-control']) !!}
                                    @endif
                                @endforeach
                            @endif
                        </div>
