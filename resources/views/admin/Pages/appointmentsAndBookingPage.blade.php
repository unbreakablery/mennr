...
<div class="py-4">
	<nav aria-label="breadcrumb" class="d-none d-md-inline-block">
	    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
	        ...
	        <li class="breadcrumb-item"><a href="#">Appointment & Booking Page</a></li>
	    </ol>
	</nav>
</div>
                ...
                <div class="row mb-4">
                    <div class="col-lg-12 col-sm-6">
                    	<div class="mb-3">
                            ...
                            {!! Form::text('title', 'Appointments and Booking', ['class'=> 'form-control', 'required'=>'required','readonly'=>'readonly']) !!}
                        </div>
                    </div>
