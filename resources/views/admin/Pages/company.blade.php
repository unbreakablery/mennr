...
<div class="py-4">
	<nav aria-label="breadcrumb" class="d-none d-md-inline-block">
	    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
	        ...
	        <li class="breadcrumb-item"><a href="#">Company Page</a></li> 
	    </ol>
	</nav>
</div>
                ...
                <div class="row mb-4">
                    <div class="col-lg-12 col-sm-6">
                    	<div class="mb-3">
                            ...
                            {!! Form::text('title', 'Company', ['class'=> 'form-control', 'required'=>'required','readonly'=>'readonly']) !!}
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="mb-4">
                            <br>
                            <label>Description</label>
                            {!! Form::hidden('txt_name[]', 'seventh_description') !!}
                            @if($page->count() == 0)
                                {!! Form::textarea('seventh_description', '', ['class'=> 'form-control', 'rows'=> '6']) !!}
                            @else
                                @foreach($page as $value)
                                    @if($value->section_title == 'seventh_description')
                                        {!! Form::textarea('seventh_description', $value->data, ['class'=> 'form-control', 'rows'=> '6']) !!}
                                    @endif
                                @endforeach
                            @endif
                        </div>  
