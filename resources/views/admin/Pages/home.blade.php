      ...
      <div class="card border-0 shadow components-section">
        <div class="card-body">
          ...
          <div class="row mb-4">
            ...
            <div class="col-lg-6 col-sm-6">
              <label class="text-success w-100 mt-4">Posts associated with this section (brands)</label>
              <ul style="list-style: decimal;">
                @foreach ($posts as $post)
            ...
            <div class="col-lg-6 col-sm-6">
              ...
              <div class="mb-4">
                ...
                @if ($page->count() == 0)
                  {!! Form::textarea('section_4_description', '', [
                      'class' => 'form-control',
                      'id' => 'section_4_description',
                      'rows' => '4',
                  ]) !!}
                @else
                  @foreach ($page as $value)
                    @if ($value->section_title == 'section_4_description')
                      {!! Form::textarea('section_4_description', $value->data, [
                          'class' => 'form-control',
                          'id' => 'section_4_description',
                          'rows' => '4',
                      ]) !!}
            ...
            <div class="col-lg-6 col-sm-6">
              ...
              <div class="mb-4">
                ...
                @if ($page->count() == 0)
                  {!! Form::textarea('section_5_description', '', [
                      'class' => 'form-control',
                      'id' => 'section_5_description',
                      'rows' => '4',
                  ]) !!}
                @else
                  @foreach ($page as $value)
                    @if ($value->section_title == 'section_5_description')
                      {!! Form::textarea('section_5_description', $value->data, [
                          'class' => 'form-control',
                          'id' => 'section_5_description',
                          'rows' => '4',
                      ]) !!}
            ...
            <div class="col-lg-6 col-sm-6">
              ...
              <div class="mb-4">
                ...
                @if ($page->count() == 0)
                  {!! Form::textarea('section_6_description', '', [
                      'class' => 'form-control',
                      'id' => 'section_6_description',
                      'rows' => '4',
                  ]) !!}
                @else
                  @foreach ($page as $value)
                    @if ($value->section_title == 'section_6_description')
                      {!! Form::textarea('section_6_description', $value->data, [
                          'class' => 'form-control',
                          'id' => 'section_6_description',
                          'rows' => '4',
                      ]) !!}
            ...
            <div class="col-lg-6 col-sm-6">
              ...
              <ul style="list-style: decimal;">
                @foreach ($testimonials as $t)
                  <li class="text-info">
                    <a href="testimonials/{{ $t->id }}/edit" target="_blank">{{ $t->author_name }},
                      {{ $t->author_role }}, {{ $t->author_designation }}</a>
                  </li>
                @endforeach
              </ul>
            </div>
