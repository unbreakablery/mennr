...
<div class="row">
  <div class="col-12 mb-4">
    <div class="card border-0 shadow components-section">
      <div class="card-body">
        {!! Form::open(['route' => ['gafd.save'], 'enctype' => 'multipart/form-data']) !!}
        @if ($errors->any())
        ...
        <div class="row mt-4 mb-4">
          <div class="col-lg-6 col-sm-6">
            <div class="mb-4">
              ...
              {{ form::text('first_name', '', ['class' => 'form-control', 'required' => true]) }}
            </div>
          </div>
          <div class="col-lg-6 col-sm-6">
            <div class="mb-4">
          ...
          <div class="col-lg-6 col-sm-6">
            <div class="mb-4">
              ...
              {{ form::tel('phone', '', ['class' => 'form-control', 'required' => true]) }}
            </div>
          </div>
          <div class="col-lg-6 col-sm-6">
            <div class="mb-4">
              <label for="business_name">Business Name<span class="text-danger">*</span></label>
              {{ form::text('business_name', '', ['class' => 'form-control', 'required' => true]) }}
            </div>
          </div>
          <div class="col-lg-6 col-sm-6">
            <div class="mb-4">
