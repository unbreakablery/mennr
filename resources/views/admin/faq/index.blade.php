...
<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            <h1 class="h4">Faq List</h1>
        </div>
        <div>
            <a href="{{ route('faq.create') }}" class="btn btn-outline-gray-600 d-inline-flex align-items-center">
                    ...
                    <tr>
                        ...
                        <td>
                        	<div class="btn-group ms-2 ms-lg-3">
                                ...
                                {!! Form::open(['route' => ['faq.destroy', $value->id], 'method' => 'DELETE' , 'enctype' => 'multipart/form-data']) !!}
