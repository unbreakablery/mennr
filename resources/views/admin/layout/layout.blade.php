...
<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
  ...
  <div class="sidebar-inner px-4 pt-3">
    <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
      <div class="d-flex align-items-center">
        <div class="avatar-lg me-4">
          <img src="{{ asset('admin_theme/assets/img/team/profile-picture-3.jpg') }}" class="card-img-top rounded-circle border-white"
            alt="Bonnie Green">
        </div>
        <div class="d-block">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      <li class="nav-item">
        <a href="{{ asset('/dashboard') }}" class="nav-link d-flex align-items-center">
      ...
      <li class="nav-item">
        ...
        <div class="multi-level collapse "
          role="list" id="main-pages" aria-expanded="false">
        ...
        <div class="multi-level collapse " role="list" id="main-pages" aria-expanded="false">
          <span class="nav-link  collapsed  d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#solution-pages">
            <span>
              <span class="sidebar-text">Solution</span>
            </span>
            <span class="link-arrow">
              <svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
            </span>
        ...
        <div class="multi-level collapse ms-4"
          role="list" id="solution-pages" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item ">
        ...
        <div class="multi-level collapse ms-4"
          role="list" id="product-pages" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item ">
...
<script type="text/javascript">window.setTimeout("document.getElementById('flash-message').style.display='none';", 2000); </script>
