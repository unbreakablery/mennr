        ...
        <div class="row mb-4">
          <div class="col-lg-12 col-sm-6">
            <div class="mb-4">
              ...
              {{ form::select('page_title', ['home'=>'Home','company'=>'Company','services'=>'Services','contact'=>'Contact'],$post->page_title, ['class'=> 'form-control form-select']) }}
            </div>
          </div>
          <div class="col-lg-6 col-sm-6">
            <div class="mb-4">
              ...
              {{ form::select('section_title', ['second_section'=>'Second Section','third_section'=>'Third Section','forth_section'=>'Forth Section'],$post->section_title, ['class'=> 'form-control form-select']) }}
            </div>
            <div class="mb-4">
          ...
          <div class="col-lg-6 col-sm-6">
            <div class="mb-4">
              ...
              {{ form::textarea('description',$post->description, ['class'=> 'form-control', 'id'=>'editor', 'rows'=> '4']) }}
            </div>
            <div class="mb-3">
